 ...
 */
 ( function() {
	...
	screenreadertext.textContent = silverQuantumScreenReaderText.expandMain;
	...
	for ( i = 0, len = parentLink.length; i < len; i++ ) {
		...
		screenreadertext.classList.add( 'screen-reader-text' );
		screenreadertext.textContent = silverQuantumScreenReaderText.expandChild;
		...
		dropdown.onclick = function() {
			...
			if ( -1 !== parentLink.className.indexOf( 'toggled-on' ) ) {
				...
				screenreadertext.textContent = silverQuantumScreenReaderText.collapseChild;
			}
		};
	}
	...
	button.onclick = function() {
		...
		if ( -1 !== container.className.indexOf( 'toggled' ) ) {
			...
			screenreadertext.textContent = silverQuantumScreenReaderText.collapseMain;
